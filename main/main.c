...
/*   Updated: 2021/03/01 03:10:07 by avarnier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	image_loop(t_game *game)
{
	...
	mlx_put_image_to_window(game->minilibx->minilibx, game->minilibx->window, game->image->image, 0, 0);
...
int	main(int argc, char **argv)
{
	...
	game->minilibx->window = mlx_new_window(game->minilibx->minilibx, game->param->width,
	game->param->height, "cub3d");
